...
<c:set var="pageTitle" value="Nuevo Paciente" scope="request"/>
...
<body>
    <%-- Re-uso del sidebar de pacientes.jsp --%>
    <aside class="sidebar">
    ...
    <main class="main-content">
        <div class="form-container">
            ...
            <form action="<c:url value='/nuevoPaciente'/>" method="POST">
                <div class="form-grid">
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea id="alergiasDentales" name="alergiasDentales" class="form-textarea" rows="3"></textarea>
                    </div>

                    <div class="form-group full-width">
                        <label for="condicionGeneralOral" class="form-label">Condición General Oral</label>
                        <textarea id="condicionGeneralOral" name="condicionGeneralOral" class="form-textarea" rows="3"></textarea>
                    </div>
